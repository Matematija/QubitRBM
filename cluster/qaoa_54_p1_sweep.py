...
if r == 0:
    ...
    def optimize_qaoa(graph, deltas, lr=1e-3, tol=1e-3, init=None, betas=(0.9, 0.999), eps=1e-6, verbose=True):
...
for n in range(nq):
    ...
    params, Fs = rx_optimization(logpsi, n, beta_opt, tol=1e-3, lr=1e-1, lookback=5, resample_phi=5, sigma=0.0,
                                   psi_mcmc_params=(2500,4,1000,54), phi_mcmc_params=(2500,4,1000,54),
